...
**Tip:** Інколи у різних інструкціях ти можеш побачити команди, що написані з символом `$` напочатку. Це домовленість, що означає початок лінії, яку треба ввести у термінал.
...
Якщо ви додалий цей гем, виконайте іще раз наступну команду:
