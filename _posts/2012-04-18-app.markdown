...
<div>
<p> Це означає, що виділений текст - це програмний код, його варто виконати чи додати до своїх файлів. Зображення біля виділеного тексту допоможе тобі знайти, яку програму використати.</p>
...
* Хмарний сервіс (як-от, Codenvy): Увійди в свій акаунт і створи новий проект, і переключись на IDE (за деталями дивись [інструкцію по встановленні](/install#using-a-cloud-service)). Термінал зазвичай знаходиться унизу вікна браузера.
...
<div>
    <p>
        Це створить новий додаток в папці <code>railsgirls</code>. Знову змінемо папку, що бути всередині нашого Rails додатку, запустивши:
    </p>
</div>
...
Маєш побачити сторінку з логотипом Rails і написом: "Yay! You're on Rails!", що означає - твій додаток готовий і запущений.
