...
* [Використання Хмарного Сервісу - Не вимагає встановлення](#використання-хмарного-сервісу)
...
* Якщо посібник просить тебе запустити браузер, наприклад `http://localhost:3000`, слідуй наступним інструкціям:
  ...
  5. Клікни "save"
  6. Клікни "run"
  7. У терміналі відкриється окрема вкладка із заголовком "run", скопіюй лінку, що йде одразу після
